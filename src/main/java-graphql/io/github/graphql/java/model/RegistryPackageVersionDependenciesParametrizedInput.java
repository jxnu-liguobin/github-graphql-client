...
public class RegistryPackageVersionDependenciesParametrizedInput implements GraphQLParametrizedInput {
    ...
    public boolean equals(Object obj) {
        ...
        final RegistryPackageVersionDependenciesParametrizedInput that = (RegistryPackageVersionDependenciesParametrizedInput) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(after, before, first, last, type);
    }
