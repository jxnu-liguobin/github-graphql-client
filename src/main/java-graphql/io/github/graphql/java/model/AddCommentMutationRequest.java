...
public class AddCommentMutationRequest implements GraphQLOperationRequest {
    ...
    public void setInput(AddCommentInputTO input) {
    ...
    public boolean equals(Object obj) {
        ...
        final AddCommentMutationRequest that = (AddCommentMutationRequest) obj;
    ...
    public static AddCommentMutationRequest.Builder builder() {
        return new AddCommentMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setInput(AddCommentInputTO input) {
            this.input = input;
            return this;
        }
