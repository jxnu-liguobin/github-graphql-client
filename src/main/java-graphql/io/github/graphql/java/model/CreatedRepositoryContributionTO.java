...
public class CreatedRepositoryContributionTO implements java.io.Serializable, CreatedRepositoryOrRestrictedContributionTO, ContributionTO {
    ...
    public boolean equals(Object obj) {
        ...
        final CreatedRepositoryContributionTO that = (CreatedRepositoryContributionTO) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(isRestricted, occurredAt, repository, resourcePath, url, user);
    }
