...
public class UpdateIssueInputTO implements java.io.Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        final UpdateIssueInputTO that = (UpdateIssueInputTO) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(assigneeIds, body, clientMutationId, id, labelIds, milestoneId, projectIds, state, title);
    }
