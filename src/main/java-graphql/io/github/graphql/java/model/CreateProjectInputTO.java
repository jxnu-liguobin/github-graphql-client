...
public class CreateProjectInputTO implements java.io.Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        final CreateProjectInputTO that = (CreateProjectInputTO) obj;
        return Objects.equals(body, that.body)
            && Objects.equals(clientMutationId, that.clientMutationId)
            && Objects.equals(name, that.name)
            && Objects.equals(ownerId, that.ownerId)
            && Objects.equals(repositoryIds, that.repositoryIds)
            && Objects.equals(template, that.template);
    }

    @Override
    public int hashCode() {
        return Objects.hash(body, clientMutationId, name, ownerId, repositoryIds, template);
    }
