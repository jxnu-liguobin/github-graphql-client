...
public class OrganizationTeamsParametrizedInput implements GraphQLParametrizedInput {
    ...
    public boolean equals(Object obj) {
        ...
        final OrganizationTeamsParametrizedInput that = (OrganizationTeamsParametrizedInput) obj;
        return Objects.equals(after, that.after)
            && Objects.equals(before, that.before)
            && Objects.equals(first, that.first)
            && Objects.equals(last, that.last)
            && Objects.equals(ldapMapped, that.ldapMapped)
            && Objects.equals(orderBy, that.orderBy)
            && Objects.equals(privacy, that.privacy)
            && Objects.equals(query, that.query)
            && Objects.equals(role, that.role)
            && Objects.equals(rootTeamsOnly, that.rootTeamsOnly)
            && Objects.equals(userLogins, that.userLogins);
    }

    @Override
    public int hashCode() {
        return Objects.hash(after, before, first, last, ldapMapped, orderBy, privacy, query, role, rootTeamsOnly, userLogins);
    }
