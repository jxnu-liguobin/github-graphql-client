...
public class AssignedEventTO implements java.io.Serializable, IssueTimelineItemsTO, PullRequestTimelineItemsTO, IssueTimelineItemTO, PullRequestTimelineItemTO, NodeTO {
    ...
    public AssignedEventTO() {
    }

    public AssignedEventTO(ActorTO actor, AssignableTO assignable, AssigneeTO assignee, String createdAt, String id, UserTO user) {
        this.actor = actor;
    ...
    public boolean equals(Object obj) {
        ...
        final AssignedEventTO that = (AssignedEventTO) obj;
    ...
    public static AssignedEventTO.Builder builder() {
        return new AssignedEventTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public AssignedEventTO build() {
            return new AssignedEventTO(actor, assignable, assignee, createdAt, id, user);
        }
