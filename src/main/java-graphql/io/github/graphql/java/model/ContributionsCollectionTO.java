...
public class ContributionsCollectionTO implements java.io.Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        final ContributionsCollectionTO that = (ContributionsCollectionTO) obj;
        return Objects.equals(contributionCalendar, that.contributionCalendar)
            && Objects.equals(contributionYears, that.contributionYears)
            && Objects.equals(doesEndInCurrentMonth, that.doesEndInCurrentMonth)
            && Objects.equals(earliestRestrictedContributionDate, that.earliestRestrictedContributionDate)
            && Objects.equals(endedAt, that.endedAt)
            && Objects.equals(firstIssueContribution, that.firstIssueContribution)
            && Objects.equals(firstPullRequestContribution, that.firstPullRequestContribution)
            && Objects.equals(firstRepositoryContribution, that.firstRepositoryContribution)
            && Objects.equals(hasActivityInThePast, that.hasActivityInThePast)
            && Objects.equals(hasAnyContributions, that.hasAnyContributions)
            && Objects.equals(hasAnyRestrictedContributions, that.hasAnyRestrictedContributions)
            && Objects.equals(isSingleDay, that.isSingleDay)
            && Objects.equals(joinedGitHubContribution, that.joinedGitHubContribution)
            && Objects.equals(latestRestrictedContributionDate, that.latestRestrictedContributionDate)
            && Objects.equals(mostRecentCollectionWithActivity, that.mostRecentCollectionWithActivity)
            && Objects.equals(mostRecentCollectionWithoutActivity, that.mostRecentCollectionWithoutActivity)
            && Objects.equals(popularIssueContribution, that.popularIssueContribution)
            && Objects.equals(popularPullRequestContribution, that.popularPullRequestContribution)
            && Objects.equals(restrictedContributionsCount, that.restrictedContributionsCount)
            && Objects.equals(startedAt, that.startedAt)
            && Objects.equals(totalCommitContributions, that.totalCommitContributions)
            && Objects.equals(totalPullRequestReviewContributions, that.totalPullRequestReviewContributions)
            && Objects.equals(totalRepositoriesWithContributedCommits, that.totalRepositoriesWithContributedCommits)
            && Objects.equals(totalRepositoriesWithContributedPullRequestReviews, that.totalRepositoriesWithContributedPullRequestReviews)
            && Objects.equals(user, that.user);
    }

    @Override
    public int hashCode() {
        return Objects.hash(contributionCalendar, contributionYears, doesEndInCurrentMonth, earliestRestrictedContributionDate, endedAt, firstIssueContribution, firstPullRequestContribution, firstRepositoryContribution, hasActivityInThePast, hasAnyContributions, hasAnyRestrictedContributions, isSingleDay, joinedGitHubContribution, latestRestrictedContributionDate, mostRecentCollectionWithActivity, mostRecentCollectionWithoutActivity, popularIssueContribution, popularPullRequestContribution, restrictedContributionsCount, startedAt, totalCommitContributions, totalPullRequestReviewContributions, totalRepositoriesWithContributedCommits, totalRepositoriesWithContributedPullRequestReviews, user);
    }
