...
public class CommitCommentTO implements java.io.Serializable, DeletableTO, UpdatableCommentTO, NodeTO, ReactableTO, RepositoryNodeTO, CommentTO, UpdatableTO {
    ...
    public CommitCommentTO() {
    }

    public CommitCommentTO(ActorTO author, CommentAuthorAssociationTO authorAssociation, String body, String bodyHTML, String bodyText, CommitTO commit, String createdAt, boolean createdViaEmail, Integer databaseId, ActorTO editor, String id, boolean includesCreatedEdit, boolean isMinimized, String lastEditedAt, String minimizedReason, String path, Integer position, String publishedAt, java.util.List<ReactionGroupTO> reactionGroups, RepositoryTO repository, String resourcePath, String updatedAt, String url, boolean viewerCanDelete, boolean viewerCanMinimize, boolean viewerCanReact, boolean viewerCanUpdate, java.util.List<CommentCannotUpdateReasonTO> viewerCannotUpdateReasons, boolean viewerDidAuthor) {
        this.author = author;
    ...
    public boolean equals(Object obj) {
        ...
        final CommitCommentTO that = (CommitCommentTO) obj;
    ...
    public static CommitCommentTO.Builder builder() {
        return new CommitCommentTO.Builder();
    }
