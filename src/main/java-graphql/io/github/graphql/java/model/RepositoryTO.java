...
public class RepositoryTO implements java.io.Serializable, SearchResultItemTO, CollectionItemContentTO, PermissionGranterTO, PinnableItemTO, RegistryPackageOwnerTO, StarrableTO, ProjectOwnerTO, SubscribableTO, UniformResourceLocatableTO, RepositoryInfoTO, NodeTO {
    ...
    public boolean equals(Object obj) {
        ...
        final RepositoryTO that = (RepositoryTO) obj;
        return Objects.equals(codeOfConduct, that.codeOfConduct)
            && Objects.equals(createdAt, that.createdAt)
            && Objects.equals(databaseId, that.databaseId)
            && Objects.equals(defaultBranchRef, that.defaultBranchRef)
            ...
            && Objects.equals(isMirror, that.isMirror)
            ...
            && Objects.equals(mergeCommitAllowed, that.mergeCommitAllowed)
            && Objects.equals(mirrorUrl, that.mirrorUrl)
            && Objects.equals(name, that.name)
            && Objects.equals(nameWithOwner, that.nameWithOwner)
            && Objects.equals(openGraphImageUrl, that.openGraphImageUrl)
            ...
            && Objects.equals(rebaseMergeAllowed, that.rebaseMergeAllowed)
            && Objects.equals(resourcePath, that.resourcePath)
            && Objects.equals(squashMergeAllowed, that.squashMergeAllowed)
            && Objects.equals(sshUrl, that.sshUrl)
            && Objects.equals(templateRepository, that.templateRepository)
            && Objects.equals(updatedAt, that.updatedAt)
            && Objects.equals(url, that.url)
            && Objects.equals(usesCustomOpenGraphImage, that.usesCustomOpenGraphImage)
            ...
            && Objects.equals(viewerCanUpdateTopics, that.viewerCanUpdateTopics)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(codeOfConduct, createdAt, databaseId, defaultBranchRef, description, descriptionHTML, diskUsage, forkCount, hasIssuesEnabled, hasWikiEnabled, homepageUrl, id, isArchived, isDisabled, isFork, isLocked, isMirror, isPrivate, isTemplate, licenseInfo, lockReason, mergeCommitAllowed, mirrorUrl, name, nameWithOwner, openGraphImageUrl, owner, parent, primaryLanguage, projectsResourcePath, projectsUrl, pushedAt, rebaseMergeAllowed, resourcePath, squashMergeAllowed, sshUrl, templateRepository, updatedAt, url, usesCustomOpenGraphImage, viewerCanAdminister, viewerCanCreateProjects, viewerCanSubscribe, viewerCanUpdateTopics, viewerHasStarred, viewerPermission, viewerSubscription);
    }
