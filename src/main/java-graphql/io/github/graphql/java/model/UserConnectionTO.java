...
public class UserConnectionTO implements java.io.Serializable {
    ...
    public UserConnectionTO(java.util.List<UserEdgeTO> edges, java.util.List<UserTO> nodes, PageInfoTO pageInfo, int totalCount) {
        this.edges = edges;
        this.nodes = nodes;
    ...
    public boolean equals(Object obj) {
        ...
        final UserConnectionTO that = (UserConnectionTO) obj;
    ...
    public static UserConnectionTO.Builder builder() {
        return new UserConnectionTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public UserConnectionTO build() {
            return new UserConnectionTO(edges, nodes, pageInfo, totalCount);
        }
