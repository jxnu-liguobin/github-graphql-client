...
class AddLabelsToLabelableMutationRequest(alias: String) extends GraphQLOperationRequest {
    ...
    def setInput(input: AddLabelsToLabelableInputTO): Unit = {
...
object AddLabelsToLabelableMutationRequest {
    ...
    class Builder {
        ...
        private var input: AddLabelsToLabelableInputTO = _
        ...
        def setInput(input: AddLabelsToLabelableInputTO): Builder = {
            this.input = input
            this
        }
