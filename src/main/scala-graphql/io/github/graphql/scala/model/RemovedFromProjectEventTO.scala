...
class RemovedFromProjectEventTO(
    actor: ActorTO,
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[RemovedFromProjectEventTO]
...
object RemovedFromProjectEventTO {

    def builder(): RemovedFromProjectEventTO.Builder = new Builder()
    ...
    class Builder {
        ...
        def build(): RemovedFromProjectEventTO = new RemovedFromProjectEventTO(actor, createdAt, databaseId, id)
