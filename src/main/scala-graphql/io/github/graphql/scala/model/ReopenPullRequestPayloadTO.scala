...
class ReopenPullRequestPayloadTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[ReopenPullRequestPayloadTO]
...
object ReopenPullRequestPayloadTO {

    def builder(): ReopenPullRequestPayloadTO.Builder = new Builder()
    ...
    class Builder {
        ...
        def build(): ReopenPullRequestPayloadTO = new ReopenPullRequestPayloadTO(clientMutationId, pullRequest)
