...
class RemoveLabelsFromLabelableInputTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[RemoveLabelsFromLabelableInputTO]
...
object RemoveLabelsFromLabelableInputTO {

    def builder(): RemoveLabelsFromLabelableInputTO.Builder = new Builder()
    ...
    class Builder {
        ...
        def build(): RemoveLabelsFromLabelableInputTO = new RemoveLabelsFromLabelableInputTO(clientMutationId, labelIds, labelableId)
