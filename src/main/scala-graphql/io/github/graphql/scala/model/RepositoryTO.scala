...
class RepositoryTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[RepositoryTO]
        Objects.equals(codeOfConduct, that.codeOfConduct) &&
    ...
    override def hashCode(): Int = {
        Objects.hash(codeOfConduct, createdAt, databaseId, defaultBranchRef, description, descriptionHTML, diskUsage, forkCount, hasIssuesEnabled, hasWikiEnabled, homepageUrl, id, isArchived, isDisabled, isFork, isLocked, isMirror, isPrivate, isTemplate, licenseInfo, lockReason, mergeCommitAllowed, mirrorUrl, name, nameWithOwner, openGraphImageUrl, owner, parent, primaryLanguage, projectsResourcePath, projectsUrl, pushedAt, rebaseMergeAllowed, resourcePath, squashMergeAllowed, sshUrl, templateRepository, updatedAt, url, usesCustomOpenGraphImage, viewerCanAdminister, viewerCanCreateProjects, viewerCanSubscribe, viewerCanUpdateTopics, viewerHasStarred, viewerPermission, viewerSubscription)
    }
}
