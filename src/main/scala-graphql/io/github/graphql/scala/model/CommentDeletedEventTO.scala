...
class CommentDeletedEventTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[CommentDeletedEventTO]
...
object CommentDeletedEventTO {

    def builder(): CommentDeletedEventTO.Builder = new Builder()
    ...
    class Builder {
        ...
        def build(): CommentDeletedEventTO = new CommentDeletedEventTO(actor, createdAt, databaseId, id)
