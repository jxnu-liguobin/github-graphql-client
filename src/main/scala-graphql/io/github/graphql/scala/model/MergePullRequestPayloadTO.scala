...
class MergePullRequestPayloadTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[MergePullRequestPayloadTO]
...
object MergePullRequestPayloadTO {

    def builder(): MergePullRequestPayloadTO.Builder = new Builder()
    ...
    class Builder {
        ...
        def build(): MergePullRequestPayloadTO = new MergePullRequestPayloadTO(clientMutationId, pullRequest)
