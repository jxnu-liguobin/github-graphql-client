...
class ClosePullRequestInputTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[ClosePullRequestInputTO]
...
object ClosePullRequestInputTO {

    def builder(): ClosePullRequestInputTO.Builder = new Builder()
    ...
    class Builder {
        ...
        def build(): ClosePullRequestInputTO = new ClosePullRequestInputTO(clientMutationId, pullRequestId)
