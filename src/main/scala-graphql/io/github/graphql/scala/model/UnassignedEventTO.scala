...
class UnassignedEventTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[UnassignedEventTO]
    ...
    override def hashCode(): Int = {
        Objects.hash(actor, assignable, assignee, createdAt, id, user)
    }
}

object UnassignedEventTO {

    def builder(): UnassignedEventTO.Builder = new Builder()
    ...
    class Builder {
        ...
        def build(): UnassignedEventTO = new UnassignedEventTO(actor, assignable, assignee, createdAt, id, user)
