...
class SearchResultItemConnectionTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[SearchResultItemConnectionTO]
        Objects.equals(codeCount, that.codeCount) &&
    ...
    override def hashCode(): Int = {
        Objects.hash(codeCount, edges, issueCount, nodes, pageInfo, repositoryCount, userCount, wikiCount)
    }
}
