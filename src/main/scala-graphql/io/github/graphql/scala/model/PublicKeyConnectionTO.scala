...
class PublicKeyConnectionTO(
    edges: Seq[PublicKeyEdgeTO],
    nodes: Seq[PublicKeyTO],
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[PublicKeyConnectionTO]
...
object PublicKeyConnectionTO {

    def builder(): PublicKeyConnectionTO.Builder = new Builder()

    class Builder {

        private var edges: Seq[PublicKeyEdgeTO] = _
        private var nodes: Seq[PublicKeyTO] = _
        private var pageInfo: PageInfoTO = _
        private var totalCount: Int = _

        def setEdges(edges: Seq[PublicKeyEdgeTO]): Builder = {
            this.edges = edges
            this
        }

        def setNodes(nodes: Seq[PublicKeyTO]): Builder = {
            this.nodes = nodes
            this
        }
        ...
        def build(): PublicKeyConnectionTO = new PublicKeyConnectionTO(edges, nodes, pageInfo, totalCount)
