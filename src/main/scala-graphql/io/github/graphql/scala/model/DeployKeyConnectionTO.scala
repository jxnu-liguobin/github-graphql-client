...
class DeployKeyConnectionTO(
    edges: Seq[DeployKeyEdgeTO],
    nodes: Seq[DeployKeyTO],
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[DeployKeyConnectionTO]
...
object DeployKeyConnectionTO {

    def builder(): DeployKeyConnectionTO.Builder = new Builder()

    class Builder {

        private var edges: Seq[DeployKeyEdgeTO] = _
        private var nodes: Seq[DeployKeyTO] = _
        private var pageInfo: PageInfoTO = _
        private var totalCount: Int = _

        def setEdges(edges: Seq[DeployKeyEdgeTO]): Builder = {
            this.edges = edges
            this
        }

        def setNodes(nodes: Seq[DeployKeyTO]): Builder = {
            this.nodes = nodes
            this
        }
        ...
        def build(): DeployKeyConnectionTO = new DeployKeyConnectionTO(edges, nodes, pageInfo, totalCount)
