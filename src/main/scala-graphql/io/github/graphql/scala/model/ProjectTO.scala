...
class ProjectTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[ProjectTO]
    ...
    override def hashCode(): Int = {
        Objects.hash(body, bodyHTML, closed, closedAt, createdAt, creator, databaseId, id, name, number, owner, resourcePath, state, updatedAt, url, viewerCanUpdate)
    }
}
