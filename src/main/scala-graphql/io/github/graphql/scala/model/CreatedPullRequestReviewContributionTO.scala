...
class CreatedPullRequestReviewContributionTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[CreatedPullRequestReviewContributionTO]
    ...
    override def hashCode(): Int = {
        Objects.hash(isRestricted, occurredAt, pullRequest, pullRequestReview, repository, resourcePath, url, user)
    }
}
