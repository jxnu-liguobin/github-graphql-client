...
class MentionedEventTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[MentionedEventTO]
...
object MentionedEventTO {

    def builder(): MentionedEventTO.Builder = new Builder()
    ...
    class Builder {
        ...
        def build(): MentionedEventTO = new MentionedEventTO(actor, createdAt, databaseId, id)
