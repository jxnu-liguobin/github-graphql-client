...
class OrganizationMemberConnectionTO(
    edges: Seq[OrganizationMemberEdgeTO],
    nodes: Seq[UserTO],
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[OrganizationMemberConnectionTO]
...
object OrganizationMemberConnectionTO {

    def builder(): OrganizationMemberConnectionTO.Builder = new Builder()

    class Builder {

        private var edges: Seq[OrganizationMemberEdgeTO] = _
        private var nodes: Seq[UserTO] = _
        private var pageInfo: PageInfoTO = _
        private var totalCount: Int = _

        def setEdges(edges: Seq[OrganizationMemberEdgeTO]): Builder = {
            this.edges = edges
            this
        }
        ...
        def build(): OrganizationMemberConnectionTO = new OrganizationMemberConnectionTO(edges, nodes, pageInfo, totalCount)
