...
class ProjectCardTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[ProjectCardTO]
    ...
    override def hashCode(): Int = {
        Objects.hash(column, content, createdAt, creator, databaseId, id, isArchived, note, project, resourcePath, state, updatedAt, url)
    }
}
