...
class UpdateBranchProtectionRulePayloadTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[UpdateBranchProtectionRulePayloadTO]
...
object UpdateBranchProtectionRulePayloadTO {

    def builder(): UpdateBranchProtectionRulePayloadTO.Builder = new Builder()
    ...
    class Builder {
        ...
        def build(): UpdateBranchProtectionRulePayloadTO = new UpdateBranchProtectionRulePayloadTO(branchProtectionRule, clientMutationId)
