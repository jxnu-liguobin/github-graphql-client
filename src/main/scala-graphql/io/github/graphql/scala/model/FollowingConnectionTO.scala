...
class FollowingConnectionTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[FollowingConnectionTO]
...
object FollowingConnectionTO {

    def builder(): FollowingConnectionTO.Builder = new Builder()
    ...
    class Builder {
        ...
        def build(): FollowingConnectionTO = new FollowingConnectionTO(edges, nodes, pageInfo, totalCount)
