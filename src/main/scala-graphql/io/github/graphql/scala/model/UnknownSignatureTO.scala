...
class UnknownSignatureTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[UnknownSignatureTO]
...
object UnknownSignatureTO {

    def builder(): UnknownSignatureTO.Builder = new Builder()
    ...
    class Builder {
        ...
        def build(): UnknownSignatureTO = new UnknownSignatureTO(email, isValid, payload, signature, signer, state, wasSignedByGitHub)
