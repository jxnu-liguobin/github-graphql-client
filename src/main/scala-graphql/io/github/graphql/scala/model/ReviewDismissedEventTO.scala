...
class ReviewDismissedEventTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[ReviewDismissedEventTO]
    ...
    override def hashCode(): Int = {
        Objects.hash(actor, createdAt, databaseId, dismissalMessage, dismissalMessageHTML, id, previousReviewState, pullRequest, pullRequestCommit, resourcePath, review, url)
    }
}
