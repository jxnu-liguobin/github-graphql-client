...
case class UserWatchingParametrizedInput(
    affiliations: Seq[RepositoryAffiliationTO] = Seq(RepositoryAffiliationTO.OWNER, RepositoryAffiliationTO.COLLABORATOR, RepositoryAffiliationTO.ORGANIZATION_MEMBER),
    after: String,
    before: String,
    first: Option[Int],
