...
case class RepositoryDeploymentsParametrizedInput(
    after: String,
    before: String,
    ...
    override def toString(): String = {
        Seq(
            ...
            if (environments != null) "environments: " + GraphQLRequestSerializer.getEntry(environments.asJava) else "",
