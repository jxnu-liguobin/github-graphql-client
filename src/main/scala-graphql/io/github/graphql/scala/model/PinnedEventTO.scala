...
class PinnedEventTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[PinnedEventTO]
...
object PinnedEventTO {

    def builder(): PinnedEventTO.Builder = new Builder()
    ...
    class Builder {
        ...
        def build(): PinnedEventTO = new PinnedEventTO(actor, createdAt, id, issue)
