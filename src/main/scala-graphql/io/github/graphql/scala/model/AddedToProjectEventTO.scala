...
class AddedToProjectEventTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[AddedToProjectEventTO]
...
object AddedToProjectEventTO {

    def builder(): AddedToProjectEventTO.Builder = new Builder()
    ...
    class Builder {
        ...
        def build(): AddedToProjectEventTO = new AddedToProjectEventTO(actor, createdAt, databaseId, id)
