...
class CommitHistoryConnectionTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[CommitHistoryConnectionTO]
...
object CommitHistoryConnectionTO {

    def builder(): CommitHistoryConnectionTO.Builder = new Builder()
    ...
    class Builder {
        ...
        def build(): CommitHistoryConnectionTO = new CommitHistoryConnectionTO(edges, nodes, pageInfo, totalCount)
