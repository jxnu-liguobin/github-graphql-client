...
class MannequinTO(
...
) extends AssigneeTO with RequestedReviewerTO with UniformResourceLocatableTO with NodeTO with ActorTO {
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[MannequinTO]
...
object MannequinTO {
    ...
    def builder(): MannequinTO.Builder = new Builder()
    ...
    class Builder {
        ...
        def build(): MannequinTO = new MannequinTO(createdAt, databaseId, id, login, resourcePath, updatedAt, url)
