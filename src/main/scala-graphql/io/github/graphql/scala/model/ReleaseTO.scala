...
class ReleaseTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[ReleaseTO]
    ...
    override def hashCode(): Int = {
        Objects.hash(author, createdAt, description, id, isDraft, isPrerelease, name, publishedAt, resourcePath, tag, tagName, updatedAt, url)
    }
}
