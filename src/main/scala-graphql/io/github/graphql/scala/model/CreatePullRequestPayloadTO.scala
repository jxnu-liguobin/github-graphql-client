...
class CreatePullRequestPayloadTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[CreatePullRequestPayloadTO]
...
object CreatePullRequestPayloadTO {

    def builder(): CreatePullRequestPayloadTO.Builder = new Builder()
    ...
    class Builder {
        ...
        def build(): CreatePullRequestPayloadTO = new CreatePullRequestPayloadTO(clientMutationId, pullRequest)
