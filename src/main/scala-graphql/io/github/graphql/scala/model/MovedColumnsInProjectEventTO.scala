...
class MovedColumnsInProjectEventTO(
    actor: ActorTO,
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[MovedColumnsInProjectEventTO]
...
object MovedColumnsInProjectEventTO {

    def builder(): MovedColumnsInProjectEventTO.Builder = new Builder()
    ...
    class Builder {
        ...
        def build(): MovedColumnsInProjectEventTO = new MovedColumnsInProjectEventTO(actor, createdAt, databaseId, id)
