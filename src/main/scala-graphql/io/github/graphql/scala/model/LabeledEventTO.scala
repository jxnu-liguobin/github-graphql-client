...
class LabeledEventTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[LabeledEventTO]
...
object LabeledEventTO {

    def builder(): LabeledEventTO.Builder = new Builder()
    ...
    class Builder {
        ...
        def build(): LabeledEventTO = new LabeledEventTO(actor, createdAt, id, label, labelable)
