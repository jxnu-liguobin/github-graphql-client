...
class TeamConnectionTO(
    edges: Seq[TeamEdgeTO],
    nodes: Seq[TeamTO],
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[TeamConnectionTO]
...
object TeamConnectionTO {

    def builder(): TeamConnectionTO.Builder = new Builder()

    class Builder {

        private var edges: Seq[TeamEdgeTO] = _
        private var nodes: Seq[TeamTO] = _
        private var pageInfo: PageInfoTO = _
        private var totalCount: Int = _

        def setEdges(edges: Seq[TeamEdgeTO]): Builder = {
            this.edges = edges
            this
        }

        def setNodes(nodes: Seq[TeamTO]): Builder = {
            this.nodes = nodes
            this
        }
        ...
        def build(): TeamConnectionTO = new TeamConnectionTO(edges, nodes, pageInfo, totalCount)
