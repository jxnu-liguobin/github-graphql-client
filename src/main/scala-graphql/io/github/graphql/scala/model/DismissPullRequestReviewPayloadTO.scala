...
class DismissPullRequestReviewPayloadTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[DismissPullRequestReviewPayloadTO]
...
object DismissPullRequestReviewPayloadTO {

    def builder(): DismissPullRequestReviewPayloadTO.Builder = new Builder()
    ...
    class Builder {
        ...
        def build(): DismissPullRequestReviewPayloadTO = new DismissPullRequestReviewPayloadTO(clientMutationId, pullRequestReview)
