...
class MarketplaceCategoryTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[MarketplaceCategoryTO]
    ...
    override def hashCode(): Int = {
        Objects.hash(description, howItWorks, id, name, primaryListingCount, resourcePath, secondaryListingCount, slug, url)
    }
}
