...
class StargazerConnectionTO(
    edges: Seq[StargazerEdgeTO],
    nodes: Seq[UserTO],
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[StargazerConnectionTO]
...
object StargazerConnectionTO {

    def builder(): StargazerConnectionTO.Builder = new Builder()

    class Builder {

        private var edges: Seq[StargazerEdgeTO] = _
        private var nodes: Seq[UserTO] = _
        private var pageInfo: PageInfoTO = _
        private var totalCount: Int = _

        def setEdges(edges: Seq[StargazerEdgeTO]): Builder = {
            this.edges = edges
            this
        }
        ...
        def build(): StargazerConnectionTO = new StargazerConnectionTO(edges, nodes, pageInfo, totalCount)
