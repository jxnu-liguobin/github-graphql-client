...
class MilestoneConnectionTO(
    edges: Seq[MilestoneEdgeTO],
    nodes: Seq[MilestoneTO],
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[MilestoneConnectionTO]
...
object MilestoneConnectionTO {

    def builder(): MilestoneConnectionTO.Builder = new Builder()

    class Builder {

        private var edges: Seq[MilestoneEdgeTO] = _
        private var nodes: Seq[MilestoneTO] = _
        private var pageInfo: PageInfoTO = _
        private var totalCount: Int = _

        def setEdges(edges: Seq[MilestoneEdgeTO]): Builder = {
            this.edges = edges
            this
        }

        def setNodes(nodes: Seq[MilestoneTO]): Builder = {
            this.nodes = nodes
            this
        }
        ...
        def build(): MilestoneConnectionTO = new MilestoneConnectionTO(edges, nodes, pageInfo, totalCount)
