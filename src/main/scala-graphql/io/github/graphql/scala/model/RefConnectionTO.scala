...
class RefConnectionTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[RefConnectionTO]
...
object RefConnectionTO {

    def builder(): RefConnectionTO.Builder = new Builder()

    class Builder {

        private var edges: Seq[RefEdgeTO] = _
        private var nodes: Seq[RefTO] = _
        private var pageInfo: PageInfoTO = _
        private var totalCount: Int = _

        def setEdges(edges: Seq[RefEdgeTO]): Builder = {
            this.edges = edges
            this
        }

        def setNodes(nodes: Seq[RefTO]): Builder = {
            this.nodes = nodes
            this
        }
        ...
        def build(): RefConnectionTO = new RefConnectionTO(edges, nodes, pageInfo, totalCount)
