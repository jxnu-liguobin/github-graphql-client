...
class PinIssueInputTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[PinIssueInputTO]
...
object PinIssueInputTO {

    def builder(): PinIssueInputTO.Builder = new Builder()
    ...
    class Builder {
        ...
        def build(): PinIssueInputTO = new PinIssueInputTO(clientMutationId, issueId)
