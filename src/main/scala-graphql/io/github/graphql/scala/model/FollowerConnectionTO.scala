...
class FollowerConnectionTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[FollowerConnectionTO]
...
object FollowerConnectionTO {

    def builder(): FollowerConnectionTO.Builder = new Builder()
    ...
    class Builder {
        ...
        def build(): FollowerConnectionTO = new FollowerConnectionTO(edges, nodes, pageInfo, totalCount)
