...
class UpdateRepositoryInputTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[UpdateRepositoryInputTO]
    ...
    override def hashCode(): Int = {
        Objects.hash(clientMutationId, description, hasIssuesEnabled, hasProjectsEnabled, hasWikiEnabled, homepageUrl, name, repositoryId, template)
    }
}
