...
class HeadRefRestoredEventTO(
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[HeadRefRestoredEventTO]
    ...
    override def hashCode(): Int = {
        Objects.hash(actor, createdAt, id, pullRequest)
    }
}

object HeadRefRestoredEventTO {

    def builder(): HeadRefRestoredEventTO.Builder = new Builder()
    ...
    class Builder {
        ...
        def build(): HeadRefRestoredEventTO = new HeadRefRestoredEventTO(actor, createdAt, id, pullRequest)
