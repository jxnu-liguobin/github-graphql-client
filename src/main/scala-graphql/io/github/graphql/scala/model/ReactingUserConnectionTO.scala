...
class ReactingUserConnectionTO(
    edges: Seq[ReactingUserEdgeTO],
    nodes: Seq[UserTO],
    ...
    override def equals(obj: Any): Boolean = {
        ...
        val that = obj.asInstanceOf[ReactingUserConnectionTO]
...
object ReactingUserConnectionTO {

    def builder(): ReactingUserConnectionTO.Builder = new Builder()

    class Builder {

        private var edges: Seq[ReactingUserEdgeTO] = _
        private var nodes: Seq[UserTO] = _
        private var pageInfo: PageInfoTO = _
        private var totalCount: Int = _

        def setEdges(edges: Seq[ReactingUserEdgeTO]): Builder = {
            this.edges = edges
            this
        }
        ...
        def build(): ReactingUserConnectionTO = new ReactingUserConnectionTO(edges, nodes, pageInfo, totalCount)
