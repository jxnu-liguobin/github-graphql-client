...
open class DeleteProjectColumnMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: DeleteProjectColumnInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as DeleteProjectColumnMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: DeleteProjectColumnInputTO
        ...
        fun setInput(input: DeleteProjectColumnInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): DeleteProjectColumnMutationRequest {
            val obj = DeleteProjectColumnMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
