...
open class CodeOfConductQueryRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as CodeOfConductQueryRequest
    ...
    class Builder {
        ...
        fun build(): CodeOfConductQueryRequest {
            val obj = CodeOfConductQueryRequest(`$alias`)
            obj.setKey(key)
            return obj
        }
