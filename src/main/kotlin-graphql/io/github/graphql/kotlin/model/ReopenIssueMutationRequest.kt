...
open class ReopenIssueMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: ReopenIssueInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as ReopenIssueMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: ReopenIssueInputTO
        ...
        fun setInput(input: ReopenIssueInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): ReopenIssueMutationRequest {
            val obj = ReopenIssueMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
