...
open class UpdatePullRequestMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: UpdatePullRequestInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as UpdatePullRequestMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: UpdatePullRequestInputTO
        ...
        fun setInput(input: UpdatePullRequestInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): UpdatePullRequestMutationRequest {
            val obj = UpdatePullRequestMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
