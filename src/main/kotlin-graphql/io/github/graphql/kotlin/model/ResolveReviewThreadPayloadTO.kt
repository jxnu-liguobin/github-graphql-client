...
open class ResolveReviewThreadPayloadTO(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as ResolveReviewThreadPayloadTO
    ...
    class Builder {
        ...
        fun build(): ResolveReviewThreadPayloadTO {
            return ResolveReviewThreadPayloadTO(clientMutationId, thread)
        }
    }
}
