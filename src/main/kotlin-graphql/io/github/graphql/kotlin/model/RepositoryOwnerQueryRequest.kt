...
open class RepositoryOwnerQueryRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as RepositoryOwnerQueryRequest
    ...
    class Builder {
        ...
        fun build(): RepositoryOwnerQueryRequest {
            val obj = RepositoryOwnerQueryRequest(`$alias`)
            obj.setLogin(login)
            return obj
        }
