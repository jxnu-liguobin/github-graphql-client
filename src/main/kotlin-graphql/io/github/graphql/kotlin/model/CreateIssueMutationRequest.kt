...
open class CreateIssueMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: CreateIssueInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as CreateIssueMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: CreateIssueInputTO
        ...
        fun setInput(input: CreateIssueInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): CreateIssueMutationRequest {
            val obj = CreateIssueMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
