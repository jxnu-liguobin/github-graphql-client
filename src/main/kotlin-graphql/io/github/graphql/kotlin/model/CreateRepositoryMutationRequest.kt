...
open class CreateRepositoryMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: CreateRepositoryInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as CreateRepositoryMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: CreateRepositoryInputTO
        ...
        fun setInput(input: CreateRepositoryInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): CreateRepositoryMutationRequest {
            val obj = CreateRepositoryMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
