...
open class RelayQueryRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as RelayQueryRequest
    ...
    class Builder {
        ...
        fun build(): RelayQueryRequest {
            val obj = RelayQueryRequest(`$alias`)
            return obj
        }
