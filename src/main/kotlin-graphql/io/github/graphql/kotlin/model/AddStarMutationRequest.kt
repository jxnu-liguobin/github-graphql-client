...
open class AddStarMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: AddStarInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as AddStarMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: AddStarInputTO
        ...
        fun setInput(input: AddStarInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): AddStarMutationRequest {
            val obj = AddStarMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
