...
open class MannequinTO(
    ...
    override
    val url: String
) : AssigneeTO, RequestedReviewerTO, UniformResourceLocatableTO, NodeTO, ActorTO {
    ...
    class Builder {
        ...
        fun build(): MannequinTO {
            return MannequinTO(createdAt, databaseId, id, login, resourcePath, updatedAt, url)
        }
    }
}
