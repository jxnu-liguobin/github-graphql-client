...
open class ReopenPullRequestInputTO(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as ReopenPullRequestInputTO
    ...
    class Builder {
        ...
        fun build(): ReopenPullRequestInputTO {
            return ReopenPullRequestInputTO(clientMutationId, pullRequestId)
        }
    }
}
