...
open class ReopenPullRequestPayloadTO(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as ReopenPullRequestPayloadTO
    ...
    class Builder {
        ...
        fun build(): ReopenPullRequestPayloadTO {
            return ReopenPullRequestPayloadTO(clientMutationId, pullRequest)
        }
    }
}
