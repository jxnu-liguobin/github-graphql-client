...
open class CloneTemplateRepositoryMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: CloneTemplateRepositoryInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as CloneTemplateRepositoryMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: CloneTemplateRepositoryInputTO
        ...
        fun setInput(input: CloneTemplateRepositoryInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): CloneTemplateRepositoryMutationRequest {
            val obj = CloneTemplateRepositoryMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
