...
open class UnmarkIssueAsDuplicateMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: UnmarkIssueAsDuplicateInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as UnmarkIssueAsDuplicateMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: UnmarkIssueAsDuplicateInputTO
        ...
        fun setInput(input: UnmarkIssueAsDuplicateInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): UnmarkIssueAsDuplicateMutationRequest {
            val obj = UnmarkIssueAsDuplicateMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
