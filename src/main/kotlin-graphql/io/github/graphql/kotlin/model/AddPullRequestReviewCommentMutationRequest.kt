...
open class AddPullRequestReviewCommentMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: AddPullRequestReviewCommentInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as AddPullRequestReviewCommentMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: AddPullRequestReviewCommentInputTO
        ...
        fun setInput(input: AddPullRequestReviewCommentInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): AddPullRequestReviewCommentMutationRequest {
            val obj = AddPullRequestReviewCommentMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
