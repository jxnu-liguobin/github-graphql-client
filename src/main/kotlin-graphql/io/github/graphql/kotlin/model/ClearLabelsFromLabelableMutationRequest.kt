...
open class ClearLabelsFromLabelableMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: ClearLabelsFromLabelableInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as ClearLabelsFromLabelableMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: ClearLabelsFromLabelableInputTO
        ...
        fun setInput(input: ClearLabelsFromLabelableInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): ClearLabelsFromLabelableMutationRequest {
            val obj = ClearLabelsFromLabelableMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
