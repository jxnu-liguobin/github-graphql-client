...
open class DeleteIssueCommentMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: DeleteIssueCommentInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as DeleteIssueCommentMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: DeleteIssueCommentInputTO
        ...
        fun setInput(input: DeleteIssueCommentInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): DeleteIssueCommentMutationRequest {
            val obj = DeleteIssueCommentMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
