...
open class LinkRepositoryToProjectMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: LinkRepositoryToProjectInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as LinkRepositoryToProjectMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: LinkRepositoryToProjectInputTO
        ...
        fun setInput(input: LinkRepositoryToProjectInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): LinkRepositoryToProjectMutationRequest {
            val obj = LinkRepositoryToProjectMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
