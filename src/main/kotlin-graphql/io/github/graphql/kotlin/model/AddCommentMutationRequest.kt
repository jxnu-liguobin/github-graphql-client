...
open class AddCommentMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: AddCommentInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as AddCommentMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: AddCommentInputTO
        ...
        fun setInput(input: AddCommentInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): AddCommentMutationRequest {
            val obj = AddCommentMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
