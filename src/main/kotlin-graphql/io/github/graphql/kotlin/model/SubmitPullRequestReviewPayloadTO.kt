...
open class SubmitPullRequestReviewPayloadTO(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as SubmitPullRequestReviewPayloadTO
    ...
    class Builder {
        ...
        fun build(): SubmitPullRequestReviewPayloadTO {
            return SubmitPullRequestReviewPayloadTO(clientMutationId, pullRequestReview)
        }
    }
}
