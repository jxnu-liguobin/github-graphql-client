...
open class UpdateProjectColumnMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: UpdateProjectColumnInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as UpdateProjectColumnMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: UpdateProjectColumnInputTO
        ...
        fun setInput(input: UpdateProjectColumnInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): UpdateProjectColumnMutationRequest {
            val obj = UpdateProjectColumnMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
