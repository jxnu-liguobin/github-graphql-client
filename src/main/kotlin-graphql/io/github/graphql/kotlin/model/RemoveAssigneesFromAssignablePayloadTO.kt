...
open class RemoveAssigneesFromAssignablePayloadTO(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as RemoveAssigneesFromAssignablePayloadTO
    ...
    class Builder {
        ...
        fun build(): RemoveAssigneesFromAssignablePayloadTO {
            return RemoveAssigneesFromAssignablePayloadTO(assignable, clientMutationId)
        }
    }
}
