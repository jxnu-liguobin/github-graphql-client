...
open class UpdateProjectCardMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: UpdateProjectCardInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as UpdateProjectCardMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: UpdateProjectCardInputTO
        ...
        fun setInput(input: UpdateProjectCardInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): UpdateProjectCardMutationRequest {
            val obj = UpdateProjectCardMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
