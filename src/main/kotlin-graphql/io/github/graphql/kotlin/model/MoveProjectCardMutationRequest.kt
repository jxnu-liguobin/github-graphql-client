...
open class MoveProjectCardMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: MoveProjectCardInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as MoveProjectCardMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: MoveProjectCardInputTO
        ...
        fun setInput(input: MoveProjectCardInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): MoveProjectCardMutationRequest {
            val obj = MoveProjectCardMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
