...
open class DeletePullRequestReviewCommentPayloadTO(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as DeletePullRequestReviewCommentPayloadTO
    ...
    class Builder {
        ...
        fun build(): DeletePullRequestReviewCommentPayloadTO {
            return DeletePullRequestReviewCommentPayloadTO(clientMutationId, pullRequestReview)
        }
    }
}
