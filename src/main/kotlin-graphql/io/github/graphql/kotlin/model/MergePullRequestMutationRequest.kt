...
open class MergePullRequestMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: MergePullRequestInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as MergePullRequestMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: MergePullRequestInputTO
        ...
        fun setInput(input: MergePullRequestInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): MergePullRequestMutationRequest {
            val obj = MergePullRequestMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
