...
open class DemilestonedEventTO(
    val actor: ActorTO?,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as DemilestonedEventTO
    ...
    class Builder {
        ...
        fun build(): DemilestonedEventTO {
            return DemilestonedEventTO(actor, createdAt, id, milestoneTitle, subject)
        }
    }
}
