...
open class RemovedFromProjectEventTO(
    val actor: ActorTO?,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as RemovedFromProjectEventTO
    ...
    class Builder {
        ...
        fun build(): RemovedFromProjectEventTO {
            return RemovedFromProjectEventTO(actor, createdAt, databaseId, id)
        }
    }
}
