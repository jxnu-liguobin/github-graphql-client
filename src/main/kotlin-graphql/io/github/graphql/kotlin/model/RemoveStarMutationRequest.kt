...
open class RemoveStarMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: RemoveStarInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as RemoveStarMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: RemoveStarInputTO
        ...
        fun setInput(input: RemoveStarInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): RemoveStarMutationRequest {
            val obj = RemoveStarMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
