...
open class UpdateIssueMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: UpdateIssueInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as UpdateIssueMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: UpdateIssueInputTO
        ...
        fun setInput(input: UpdateIssueInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): UpdateIssueMutationRequest {
            val obj = UpdateIssueMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
