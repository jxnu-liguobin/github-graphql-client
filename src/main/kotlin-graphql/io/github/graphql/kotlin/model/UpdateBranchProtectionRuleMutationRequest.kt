...
open class UpdateBranchProtectionRuleMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: UpdateBranchProtectionRuleInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as UpdateBranchProtectionRuleMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: UpdateBranchProtectionRuleInputTO
        ...
        fun setInput(input: UpdateBranchProtectionRuleInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): UpdateBranchProtectionRuleMutationRequest {
            val obj = UpdateBranchProtectionRuleMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
