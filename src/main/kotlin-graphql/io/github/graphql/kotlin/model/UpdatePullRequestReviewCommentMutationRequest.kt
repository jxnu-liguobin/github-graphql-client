...
open class UpdatePullRequestReviewCommentMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: UpdatePullRequestReviewCommentInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as UpdatePullRequestReviewCommentMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: UpdatePullRequestReviewCommentInputTO
        ...
        fun setInput(input: UpdatePullRequestReviewCommentInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): UpdatePullRequestReviewCommentMutationRequest {
            val obj = UpdatePullRequestReviewCommentMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
