...
open class ViewerQueryRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as ViewerQueryRequest
    ...
    class Builder {
        ...
        fun build(): ViewerQueryRequest {
            val obj = ViewerQueryRequest(`$alias`)
            return obj
        }
