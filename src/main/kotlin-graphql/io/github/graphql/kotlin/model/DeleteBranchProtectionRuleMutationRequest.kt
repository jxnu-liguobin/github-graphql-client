...
open class DeleteBranchProtectionRuleMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: DeleteBranchProtectionRuleInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as DeleteBranchProtectionRuleMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: DeleteBranchProtectionRuleInputTO
        ...
        fun setInput(input: DeleteBranchProtectionRuleInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): DeleteBranchProtectionRuleMutationRequest {
            val obj = DeleteBranchProtectionRuleMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
