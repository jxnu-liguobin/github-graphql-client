...
open class ConvertedNoteToIssueEventTO(
    val actor: ActorTO?,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as ConvertedNoteToIssueEventTO
    ...
    class Builder {
        ...
        fun build(): ConvertedNoteToIssueEventTO {
            return ConvertedNoteToIssueEventTO(actor, createdAt, databaseId, id)
        }
    }
}
