...
open class ResolveReviewThreadMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: ResolveReviewThreadInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as ResolveReviewThreadMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: ResolveReviewThreadInputTO
        ...
        fun setInput(input: ResolveReviewThreadInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): ResolveReviewThreadMutationRequest {
            val obj = ResolveReviewThreadMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
