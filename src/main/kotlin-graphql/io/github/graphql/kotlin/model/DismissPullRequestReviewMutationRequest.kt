...
open class DismissPullRequestReviewMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: DismissPullRequestReviewInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as DismissPullRequestReviewMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: DismissPullRequestReviewInputTO
        ...
        fun setInput(input: DismissPullRequestReviewInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): DismissPullRequestReviewMutationRequest {
            val obj = DismissPullRequestReviewMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
