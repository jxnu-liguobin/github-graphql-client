...
open class DeleteProjectMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: DeleteProjectInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as DeleteProjectMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: DeleteProjectInputTO
        ...
        fun setInput(input: DeleteProjectInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): DeleteProjectMutationRequest {
            val obj = DeleteProjectMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
