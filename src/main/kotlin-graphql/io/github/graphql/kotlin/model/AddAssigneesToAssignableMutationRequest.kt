...
open class AddAssigneesToAssignableMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: AddAssigneesToAssignableInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as AddAssigneesToAssignableMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: AddAssigneesToAssignableInputTO
        ...
        fun setInput(input: AddAssigneesToAssignableInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): AddAssigneesToAssignableMutationRequest {
            val obj = AddAssigneesToAssignableMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
