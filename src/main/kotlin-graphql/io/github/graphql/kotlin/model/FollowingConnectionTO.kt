...
open class FollowingConnectionTO(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as FollowingConnectionTO
    ...
    class Builder {
        ...
        fun build(): FollowingConnectionTO {
            return FollowingConnectionTO(edges, nodes, pageInfo, totalCount)
        }
    }
}
