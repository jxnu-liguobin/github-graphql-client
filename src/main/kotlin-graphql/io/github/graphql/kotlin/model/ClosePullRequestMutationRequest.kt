...
open class ClosePullRequestMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: ClosePullRequestInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as ClosePullRequestMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: ClosePullRequestInputTO
        ...
        fun setInput(input: ClosePullRequestInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): ClosePullRequestMutationRequest {
            val obj = ClosePullRequestMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
