...
open class UpdateProjectCardPayloadTO(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as UpdateProjectCardPayloadTO
    ...
    class Builder {
        ...
        fun build(): UpdateProjectCardPayloadTO {
            return UpdateProjectCardPayloadTO(clientMutationId, projectCard)
        }
    }
}
