...
open class ReopenPullRequestMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: ReopenPullRequestInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as ReopenPullRequestMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: ReopenPullRequestInputTO
        ...
        fun setInput(input: ReopenPullRequestInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): ReopenPullRequestMutationRequest {
            val obj = ReopenPullRequestMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
