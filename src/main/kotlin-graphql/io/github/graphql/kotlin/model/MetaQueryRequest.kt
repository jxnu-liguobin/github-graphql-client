...
open class MetaQueryRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as MetaQueryRequest
    ...
    class Builder {
        ...
        fun build(): MetaQueryRequest {
            val obj = MetaQueryRequest(`$alias`)
            return obj
        }
