...
open class RemoveLabelsFromLabelableMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: RemoveLabelsFromLabelableInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as RemoveLabelsFromLabelableMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: RemoveLabelsFromLabelableInputTO
        ...
        fun setInput(input: RemoveLabelsFromLabelableInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): RemoveLabelsFromLabelableMutationRequest {
            val obj = RemoveLabelsFromLabelableMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
