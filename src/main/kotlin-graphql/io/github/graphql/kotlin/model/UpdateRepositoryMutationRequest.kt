...
open class UpdateRepositoryMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: UpdateRepositoryInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as UpdateRepositoryMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: UpdateRepositoryInputTO
        ...
        fun setInput(input: UpdateRepositoryInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): UpdateRepositoryMutationRequest {
            val obj = UpdateRepositoryMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
