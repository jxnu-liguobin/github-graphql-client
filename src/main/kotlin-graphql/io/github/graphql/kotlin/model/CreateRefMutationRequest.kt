...
open class CreateRefMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: CreateRefInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as CreateRefMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: CreateRefInputTO
        ...
        fun setInput(input: CreateRefInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): CreateRefMutationRequest {
            val obj = CreateRefMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
