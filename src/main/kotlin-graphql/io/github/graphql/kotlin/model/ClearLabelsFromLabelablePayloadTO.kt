...
open class ClearLabelsFromLabelablePayloadTO(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as ClearLabelsFromLabelablePayloadTO
    ...
    class Builder {
        ...
        fun build(): ClearLabelsFromLabelablePayloadTO {
            return ClearLabelsFromLabelablePayloadTO(clientMutationId, labelable)
        }
    }
}
