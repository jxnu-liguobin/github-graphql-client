...
open class AcceptTopicSuggestionMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: AcceptTopicSuggestionInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as AcceptTopicSuggestionMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: AcceptTopicSuggestionInputTO
        ...
        fun setInput(input: AcceptTopicSuggestionInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): AcceptTopicSuggestionMutationRequest {
            val obj = AcceptTopicSuggestionMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
