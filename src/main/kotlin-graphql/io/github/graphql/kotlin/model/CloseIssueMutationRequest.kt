...
open class CloseIssueMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: CloseIssueInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as CloseIssueMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: CloseIssueInputTO
        ...
        fun setInput(input: CloseIssueInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): CloseIssueMutationRequest {
            val obj = CloseIssueMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
