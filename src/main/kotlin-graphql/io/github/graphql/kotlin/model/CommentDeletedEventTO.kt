...
open class CommentDeletedEventTO(
    val actor: ActorTO?,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as CommentDeletedEventTO
    ...
    class Builder {
        ...
        fun build(): CommentDeletedEventTO {
            return CommentDeletedEventTO(actor, createdAt, databaseId, id)
        }
    }
}
