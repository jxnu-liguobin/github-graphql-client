...
open class CloneProjectMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: CloneProjectInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as CloneProjectMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: CloneProjectInputTO
        ...
        fun setInput(input: CloneProjectInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): CloneProjectMutationRequest {
            val obj = CloneProjectMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
