...
open class DeletePullRequestReviewCommentMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: DeletePullRequestReviewCommentInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as DeletePullRequestReviewCommentMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: DeletePullRequestReviewCommentInputTO
        ...
        fun setInput(input: DeletePullRequestReviewCommentInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): DeletePullRequestReviewCommentMutationRequest {
            val obj = DeletePullRequestReviewCommentMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
