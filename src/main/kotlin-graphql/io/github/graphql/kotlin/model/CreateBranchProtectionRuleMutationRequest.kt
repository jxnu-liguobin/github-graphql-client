...
open class CreateBranchProtectionRuleMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: CreateBranchProtectionRuleInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as CreateBranchProtectionRuleMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: CreateBranchProtectionRuleInputTO
        ...
        fun setInput(input: CreateBranchProtectionRuleInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): CreateBranchProtectionRuleMutationRequest {
            val obj = CreateBranchProtectionRuleMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
