...
open class ReactionOrderTO(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as ReactionOrderTO
    ...
    class Builder {
        ...
        private lateinit var field: ReactionOrderFieldTO
        ...
        fun setField(field: ReactionOrderFieldTO): Builder {
            this.field = field
            return this
        }

        fun build(): ReactionOrderTO {
            return ReactionOrderTO(direction, field)
        }
    }
}
