...
open class CreatePullRequestMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: CreatePullRequestInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as CreatePullRequestMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: CreatePullRequestInputTO
        ...
        fun setInput(input: CreatePullRequestInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): CreatePullRequestMutationRequest {
            val obj = CreatePullRequestMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
