...
open class UnknownSignatureTO(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as UnknownSignatureTO
    ...
    class Builder {
        ...
        fun build(): UnknownSignatureTO {
            return UnknownSignatureTO(email, isValid, payload, signature, signer, state, wasSignedByGitHub)
        }
    }
}
