...
open class UnlinkRepositoryFromProjectMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: UnlinkRepositoryFromProjectInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as UnlinkRepositoryFromProjectMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: UnlinkRepositoryFromProjectInputTO
        ...
        fun setInput(input: UnlinkRepositoryFromProjectInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): UnlinkRepositoryFromProjectMutationRequest {
            val obj = UnlinkRepositoryFromProjectMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
