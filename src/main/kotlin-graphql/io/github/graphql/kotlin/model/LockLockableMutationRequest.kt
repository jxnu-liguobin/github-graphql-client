...
open class LockLockableMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: LockLockableInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as LockLockableMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: LockLockableInputTO
        ...
        fun setInput(input: LockLockableInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): LockLockableMutationRequest {
            val obj = LockLockableMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
