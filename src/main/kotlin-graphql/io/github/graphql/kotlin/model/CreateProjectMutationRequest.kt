...
open class CreateProjectMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: CreateProjectInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as CreateProjectMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: CreateProjectInputTO
        ...
        fun setInput(input: CreateProjectInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): CreateProjectMutationRequest {
            val obj = CreateProjectMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
