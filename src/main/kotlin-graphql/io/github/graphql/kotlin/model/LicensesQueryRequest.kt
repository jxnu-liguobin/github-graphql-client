...
open class LicensesQueryRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as LicensesQueryRequest
    ...
    class Builder {
        ...
        fun build(): LicensesQueryRequest {
            val obj = LicensesQueryRequest(`$alias`)
            return obj
        }
