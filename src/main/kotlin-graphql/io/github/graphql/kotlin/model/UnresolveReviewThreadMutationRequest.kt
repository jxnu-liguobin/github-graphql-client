...
open class UnresolveReviewThreadMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: UnresolveReviewThreadInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as UnresolveReviewThreadMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: UnresolveReviewThreadInputTO
        ...
        fun setInput(input: UnresolveReviewThreadInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): UnresolveReviewThreadMutationRequest {
            val obj = UnresolveReviewThreadMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
