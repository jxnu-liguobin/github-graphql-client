...
open class CreatePullRequestPayloadTO(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as CreatePullRequestPayloadTO
    ...
    class Builder {
        ...
        fun build(): CreatePullRequestPayloadTO {
            return CreatePullRequestPayloadTO(clientMutationId, pullRequest)
        }
    }
}
