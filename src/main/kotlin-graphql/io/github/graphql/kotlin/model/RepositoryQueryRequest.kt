...
open class RepositoryQueryRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as RepositoryQueryRequest
    ...
    class Builder {
        ...
        fun build(): RepositoryQueryRequest {
            val obj = RepositoryQueryRequest(`$alias`)
            obj.setName(name)
            obj.setOwner(owner)
            return obj
        }
