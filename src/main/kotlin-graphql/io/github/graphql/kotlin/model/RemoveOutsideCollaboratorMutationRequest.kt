...
open class RemoveOutsideCollaboratorMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: RemoveOutsideCollaboratorInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as RemoveOutsideCollaboratorMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: RemoveOutsideCollaboratorInputTO
        ...
        fun setInput(input: RemoveOutsideCollaboratorInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): RemoveOutsideCollaboratorMutationRequest {
            val obj = RemoveOutsideCollaboratorMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
