...
open class RemoveReactionInputTO(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as RemoveReactionInputTO
    ...
    class Builder {
        ...
        fun build(): RemoveReactionInputTO {
            return RemoveReactionInputTO(clientMutationId, content, subjectId)
        }
    }
}
