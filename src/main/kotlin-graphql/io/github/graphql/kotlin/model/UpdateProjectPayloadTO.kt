...
open class UpdateProjectPayloadTO(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as UpdateProjectPayloadTO
    ...
    class Builder {
        ...
        fun build(): UpdateProjectPayloadTO {
            return UpdateProjectPayloadTO(clientMutationId, project)
        }
    }
}
