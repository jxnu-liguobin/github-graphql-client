...
open class UnlockLockableMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: UnlockLockableInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as UnlockLockableMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: UnlockLockableInputTO
        ...
        fun setInput(input: UnlockLockableInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): UnlockLockableMutationRequest {
            val obj = UnlockLockableMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
