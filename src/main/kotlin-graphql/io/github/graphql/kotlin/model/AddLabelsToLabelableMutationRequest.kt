...
open class AddLabelsToLabelableMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: AddLabelsToLabelableInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as AddLabelsToLabelableMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: AddLabelsToLabelableInputTO
        ...
        fun setInput(input: AddLabelsToLabelableInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): AddLabelsToLabelableMutationRequest {
            val obj = AddLabelsToLabelableMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
