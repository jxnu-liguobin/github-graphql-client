...
open class UpdateRefMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: UpdateRefInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as UpdateRefMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: UpdateRefInputTO
        ...
        fun setInput(input: UpdateRefInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): UpdateRefMutationRequest {
            val obj = UpdateRefMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
