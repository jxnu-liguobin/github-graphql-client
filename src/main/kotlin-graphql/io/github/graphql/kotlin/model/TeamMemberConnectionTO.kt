...
open class TeamMemberConnectionTO(
    val edges: List<TeamMemberEdgeTO?>?,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as TeamMemberConnectionTO
    ...
    class Builder {
        ...
        private var edges: List<TeamMemberEdgeTO?>? = null
        private var nodes: List<UserTO?>? = null
        private lateinit var pageInfo: PageInfoTO
        private var totalCount: Int = 0

        fun setEdges(edges: List<TeamMemberEdgeTO?>?): Builder {
            this.edges = edges
            return this
        }
        ...
        fun build(): TeamMemberConnectionTO {
            return TeamMemberConnectionTO(edges, nodes, pageInfo, totalCount)
        }
    }
}
