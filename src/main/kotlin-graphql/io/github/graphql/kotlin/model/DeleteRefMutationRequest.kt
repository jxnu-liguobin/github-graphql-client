...
open class DeleteRefMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: DeleteRefInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as DeleteRefMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: DeleteRefInputTO
        ...
        fun setInput(input: DeleteRefInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): DeleteRefMutationRequest {
            val obj = DeleteRefMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
