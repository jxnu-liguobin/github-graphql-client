...
open class LinkRepositoryToProjectInputTO(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as LinkRepositoryToProjectInputTO
    ...
    class Builder {
        ...
        fun build(): LinkRepositoryToProjectInputTO {
            return LinkRepositoryToProjectInputTO(clientMutationId, projectId, repositoryId)
        }
    }
}
