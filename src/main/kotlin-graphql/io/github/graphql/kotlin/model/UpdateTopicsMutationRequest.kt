...
open class UpdateTopicsMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: UpdateTopicsInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as UpdateTopicsMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: UpdateTopicsInputTO
        ...
        fun setInput(input: UpdateTopicsInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): UpdateTopicsMutationRequest {
            val obj = UpdateTopicsMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
