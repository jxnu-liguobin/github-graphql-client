...
open class MoveProjectColumnMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: MoveProjectColumnInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as MoveProjectColumnMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: MoveProjectColumnInputTO
        ...
        fun setInput(input: MoveProjectColumnInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): MoveProjectColumnMutationRequest {
            val obj = MoveProjectColumnMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
