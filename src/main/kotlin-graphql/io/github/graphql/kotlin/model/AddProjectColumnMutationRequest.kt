...
open class AddProjectColumnMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: AddProjectColumnInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as AddProjectColumnMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: AddProjectColumnInputTO
        ...
        fun setInput(input: AddProjectColumnInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): AddProjectColumnMutationRequest {
            val obj = AddProjectColumnMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
