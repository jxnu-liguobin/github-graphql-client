...
open class UpdateSubscriptionMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: UpdateSubscriptionInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as UpdateSubscriptionMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: UpdateSubscriptionInputTO
        ...
        fun setInput(input: UpdateSubscriptionInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): UpdateSubscriptionMutationRequest {
            val obj = UpdateSubscriptionMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
