...
open class CreatedPullRequestReviewContributionTO(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as CreatedPullRequestReviewContributionTO
    ...
    class Builder {
        ...
        private lateinit var pullRequestReview: PullRequestReviewTO
        ...
        fun build(): CreatedPullRequestReviewContributionTO {
            return CreatedPullRequestReviewContributionTO(isRestricted, occurredAt, pullRequest, pullRequestReview, repository, resourcePath, url, user)
        }
    }
}
