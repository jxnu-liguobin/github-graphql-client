...
open class RemoveAssigneesFromAssignableMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: RemoveAssigneesFromAssignableInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as RemoveAssigneesFromAssignableMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: RemoveAssigneesFromAssignableInputTO
        ...
        fun setInput(input: RemoveAssigneesFromAssignableInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): RemoveAssigneesFromAssignableMutationRequest {
            val obj = RemoveAssigneesFromAssignableMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
