...
open class DeletePullRequestReviewPayloadTO(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as DeletePullRequestReviewPayloadTO
    ...
    class Builder {
        ...
        fun build(): DeletePullRequestReviewPayloadTO {
            return DeletePullRequestReviewPayloadTO(clientMutationId, pullRequestReview)
        }
    }
}
