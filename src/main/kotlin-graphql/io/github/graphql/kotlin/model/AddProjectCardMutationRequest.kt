...
open class AddProjectCardMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: AddProjectCardInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as AddProjectCardMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: AddProjectCardInputTO
        ...
        fun setInput(input: AddProjectCardInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): AddProjectCardMutationRequest {
            val obj = AddProjectCardMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
