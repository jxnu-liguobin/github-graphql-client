...
open class DeleteProjectCardMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: DeleteProjectCardInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as DeleteProjectCardMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: DeleteProjectCardInputTO
        ...
        fun setInput(input: DeleteProjectCardInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): DeleteProjectCardMutationRequest {
            val obj = DeleteProjectCardMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
