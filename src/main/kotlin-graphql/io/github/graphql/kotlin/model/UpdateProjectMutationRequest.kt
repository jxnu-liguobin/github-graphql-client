...
open class UpdateProjectMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: UpdateProjectInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as UpdateProjectMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: UpdateProjectInputTO
        ...
        fun setInput(input: UpdateProjectInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): UpdateProjectMutationRequest {
            val obj = UpdateProjectMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
