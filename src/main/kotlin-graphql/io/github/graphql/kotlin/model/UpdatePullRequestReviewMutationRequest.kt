...
open class UpdatePullRequestReviewMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: UpdatePullRequestReviewInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as UpdatePullRequestReviewMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: UpdatePullRequestReviewInputTO
        ...
        fun setInput(input: UpdatePullRequestReviewInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): UpdatePullRequestReviewMutationRequest {
            val obj = UpdatePullRequestReviewMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
