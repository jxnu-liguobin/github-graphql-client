...
open class RemoveReactionMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: RemoveReactionInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as RemoveReactionMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: RemoveReactionInputTO
        ...
        fun setInput(input: RemoveReactionInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): RemoveReactionMutationRequest {
            val obj = RemoveReactionMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
