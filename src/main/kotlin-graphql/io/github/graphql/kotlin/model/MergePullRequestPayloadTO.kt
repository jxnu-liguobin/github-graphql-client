...
open class MergePullRequestPayloadTO(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as MergePullRequestPayloadTO
    ...
    class Builder {
        ...
        fun build(): MergePullRequestPayloadTO {
            return MergePullRequestPayloadTO(clientMutationId, pullRequest)
        }
    }
}
