...
open class AddReactionMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: AddReactionInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as AddReactionMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: AddReactionInputTO
        ...
        fun setInput(input: AddReactionInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): AddReactionMutationRequest {
            val obj = AddReactionMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
