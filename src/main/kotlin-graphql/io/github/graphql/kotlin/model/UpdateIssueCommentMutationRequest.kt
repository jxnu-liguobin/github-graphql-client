...
open class UpdateIssueCommentMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: UpdateIssueCommentInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as UpdateIssueCommentMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: UpdateIssueCommentInputTO
        ...
        fun setInput(input: UpdateIssueCommentInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): UpdateIssueCommentMutationRequest {
            val obj = UpdateIssueCommentMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
