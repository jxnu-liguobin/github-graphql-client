...
open class StargazerConnectionTO(
    val edges: List<StargazerEdgeTO?>?,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as StargazerConnectionTO
    ...
    class Builder {
        ...
        private var edges: List<StargazerEdgeTO?>? = null
        private var nodes: List<UserTO?>? = null
        private lateinit var pageInfo: PageInfoTO
        private var totalCount: Int = 0

        fun setEdges(edges: List<StargazerEdgeTO?>?): Builder {
            this.edges = edges
            return this
        }
        ...
        fun build(): StargazerConnectionTO {
            return StargazerConnectionTO(edges, nodes, pageInfo, totalCount)
        }
    }
}
