...
open class AddedToProjectEventTO(
    val actor: ActorTO?,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as AddedToProjectEventTO
    ...
    class Builder {
        ...
        fun build(): AddedToProjectEventTO {
            return AddedToProjectEventTO(actor, createdAt, databaseId, id)
        }
    }
}
