...
open class DeleteIssueMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: DeleteIssueInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as DeleteIssueMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: DeleteIssueInputTO
        ...
        fun setInput(input: DeleteIssueInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): DeleteIssueMutationRequest {
            val obj = DeleteIssueMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
