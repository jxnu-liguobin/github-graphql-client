...
open class ConvertProjectCardNoteToIssueMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: ConvertProjectCardNoteToIssueInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as ConvertProjectCardNoteToIssueMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: ConvertProjectCardNoteToIssueInputTO
        ...
        fun setInput(input: ConvertProjectCardNoteToIssueInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): ConvertProjectCardNoteToIssueMutationRequest {
            val obj = ConvertProjectCardNoteToIssueMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
