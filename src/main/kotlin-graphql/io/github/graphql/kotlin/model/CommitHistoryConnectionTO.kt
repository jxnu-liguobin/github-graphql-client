...
open class CommitHistoryConnectionTO(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as CommitHistoryConnectionTO
    ...
    class Builder {
        ...
        fun build(): CommitHistoryConnectionTO {
            return CommitHistoryConnectionTO(edges, nodes, pageInfo, totalCount)
        }
    }
}
