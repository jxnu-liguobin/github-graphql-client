...
open class UserQueryRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as UserQueryRequest
    ...
    class Builder {
        ...
        fun build(): UserQueryRequest {
            val obj = UserQueryRequest(`$alias`)
            obj.setLogin(login)
            return obj
        }
