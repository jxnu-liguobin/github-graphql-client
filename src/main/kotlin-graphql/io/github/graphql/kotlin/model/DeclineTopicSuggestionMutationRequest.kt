...
open class DeclineTopicSuggestionMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: DeclineTopicSuggestionInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as DeclineTopicSuggestionMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: DeclineTopicSuggestionInputTO
        ...
        fun setInput(input: DeclineTopicSuggestionInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): DeclineTopicSuggestionMutationRequest {
            val obj = DeclineTopicSuggestionMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
