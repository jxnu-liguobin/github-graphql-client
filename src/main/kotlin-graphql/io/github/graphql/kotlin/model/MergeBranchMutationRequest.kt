...
open class MergeBranchMutationRequest(private val alias: String?) : GraphQLOperationRequest {
    ...
    fun setInput(input: MergeBranchInputTO) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as MergeBranchMutationRequest
    ...
    class Builder {
        ...
        private lateinit var input: MergeBranchInputTO
        ...
        fun setInput(input: MergeBranchInputTO): Builder {
            this.input = input
            return this
        }

        fun build(): MergeBranchMutationRequest {
            val obj = MergeBranchMutationRequest(`$alias`)
            obj.setInput(input)
            return obj
        }
