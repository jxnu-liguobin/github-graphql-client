...
open class RemoveLabelsFromLabelableInputTO(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as RemoveLabelsFromLabelableInputTO
    ...
    class Builder {
        ...
        fun build(): RemoveLabelsFromLabelableInputTO {
            return RemoveLabelsFromLabelableInputTO(clientMutationId, labelIds, labelableId)
        }
    }
}
